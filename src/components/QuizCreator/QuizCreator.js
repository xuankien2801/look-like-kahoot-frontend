...
function QuizCreator() {
  ...
  const handleQuestionSubmit = () => {
    if (questionData.question === "") {
      ...
      alert("Nhập câu trả lời của bạn")
  ...
  if (user === null) {
    return <h1>Đăng nhập vào tài khoản giáo viên của bạn để tạo một bài kiểm tra</h1>
  } else if (user.result.userType !== "Teacher") {
    return <h1>Chỉ giáo viên mới có thể tạo quiz </h1>
  }
    ...
    <section className={styles.section}>
              ...
              isQuestionDataSave
                ...
                : alert(
                    isLanguageEnglish
                      ...
                      : "Lưu thay đổi trong câu hỏi trước"
                  )
            }}
            className={styles["add-question-button"]}
          >
            {isLanguageEnglish ? "Add question" : "Thêm câu hỏi mới"}
          </button>
        </div>
      </div>
      ...
      <div className={styles.options}>
        ...
        >
          ...
          <div className={styles["option-label"]}>
            <label>
              {isLanguageEnglish ? "Points per question" : "Điểm từng câu"}
            </label>
          </div>
          <input
            type="number"
        ...
        >
          ...
          <div className={styles.option}>
            ...
            >
              <option defaultValue disabled>
                {isLanguageEnglish ? "Set time limit" : "Cài đặt thời gian giới hạn"}
              </option>
              <option value={5}>
          ...
          <div className={styles.option}>
            <div className={styles["option-label"]}>
              ...
              <label>
                {isLanguageEnglish ? "Answer options" : "Lựa chọn trả lời"}
              </label>
            </div>
            <select onChange={changeMaxCorrectAnswerCount}>
              <option defaultValue disabled value="1">
                {isLanguageEnglish
                  ? "Set answer options"
                  : "Cài đặt lựa chọn trả lời"}
              </option>
              <option value="1">
                {isLanguageEnglish ? "Single choice" : "Lựa chọn 1 câu trả lời"}
              </option>
              <option value="4">
                {isLanguageEnglish ? "Multiple choice" : "Lụa chọn nhiều câu trả lời"}
              </option>
            </select>
          </div>
          <div>
            <button
              ...
              className={styles["option-button"]}
            >
              {isLanguageEnglish ? "Save changes" : "Lưu thay đổi câu hỏi"}
            </button>
            <button
              onClick={handleQuestionRemove}
              className={styles["option-button"]}
            >
              {isLanguageEnglish ? "Delete" : "Xóa câu hỏi"}
            </button>
          </div>
          <div>
            <button
              ...
              onClick={handleQuizSubmit}
            >
              {isLanguageEnglish ? "Submit" : "Lưu bài quiz"}
            </button>
          </div>
        </div>
      </div>
